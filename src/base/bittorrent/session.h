...
namespace BitTorrent
{
    ...
    public:
        ...
        virtual bool isPerformanceWarningEnabled() const;
        virtual void setPerformanceWarningEnabled(bool enable);
        virtual int saveResumeDataInterval() const;
        virtual void setSaveResumeDataInterval(int value);
        virtual QMap<QString, QVariant> ports() const;
        virtual void setPorts(const QMap<QString, QVariant> ports);
        virtual QMap<QString, QVariant> portsEnabled() const;
        virtual void setPortsEnabled(const QMap<QString, QVariant> portsEnabled);
        virtual QString networkInterface() const;
        virtual void setNetworkInterface(const QString &iface);
        virtual QString networkInterfaceName() const;
        virtual void setNetworkInterfaceName(const QString &name);
        virtual QString networkInterfaceAddress() const;
        virtual void setNetworkInterfaceAddress(const QString &address);
        virtual int encryption() const;
        virtual void setEncryption(int state);
        virtual int maxActiveCheckingTorrents() const;
        virtual void setMaxActiveCheckingTorrents(int val);
        virtual bool isProxyPeerConnectionsEnabled() const;
        virtual void setProxyPeerConnectionsEnabled(bool enabled);
        virtual ChokingAlgorithm chokingAlgorithm() const;
        virtual void setChokingAlgorithm(ChokingAlgorithm mode);
        virtual SeedChokingAlgorithm seedChokingAlgorithm() const;
        virtual void setSeedChokingAlgorithm(SeedChokingAlgorithm mode);
        virtual bool isAddTrackersEnabled() const;
        virtual void setAddTrackersEnabled(bool enabled);
        virtual QString additionalTrackers() const;
        virtual void setAdditionalTrackers(const QString &trackers);
        virtual bool isIPFilteringEnabled() const;
        virtual void setIPFilteringEnabled(bool enabled);
        virtual Path IPFilterFile() const;
        virtual void setIPFilterFile(const Path &path);
        virtual bool announceToAllTrackers() const;
        virtual void setAnnounceToAllTrackers(bool val);
        virtual bool announceToAllTiers() const;
        virtual void setAnnounceToAllTiers(bool val);
        virtual int peerTurnover() const;
        virtual void setPeerTurnover(int val);
        virtual int peerTurnoverCutoff() const;
        virtual void setPeerTurnoverCutoff(int val);
        virtual int peerTurnoverInterval() const;
        virtual void setPeerTurnoverInterval(int val);
        virtual int requestQueueSize() const;
        virtual void setRequestQueueSize(int val);
        virtual int asyncIOThreads() const;
        virtual void setAsyncIOThreads(int num);
        virtual int hashingThreads() const;
        virtual void setHashingThreads(int num);
        virtual int filePoolSize() const;
        virtual void setFilePoolSize(int size);
        virtual int checkingMemUsage() const;
        virtual void setCheckingMemUsage(int size);
        virtual int diskCacheSize() const;
        virtual void setDiskCacheSize(int size);
        virtual int diskCacheTTL() const;
        virtual void setDiskCacheTTL(int ttl);
        virtual qint64 diskQueueSize() const;
        virtual void setDiskQueueSize(qint64 size);
        virtual DiskIOType diskIOType() const;
        virtual void setDiskIOType(DiskIOType type);
        virtual DiskIOReadMode diskIOReadMode() const;
        virtual void setDiskIOReadMode(DiskIOReadMode mode);
        virtual DiskIOWriteMode diskIOWriteMode() const;
        virtual void setDiskIOWriteMode(DiskIOWriteMode mode);
        virtual bool isCoalesceReadWriteEnabled() const;
        virtual void setCoalesceReadWriteEnabled(bool enabled);
        virtual bool usePieceExtentAffinity() const;
        virtual void setPieceExtentAffinity(bool enabled);
        virtual bool isSuggestModeEnabled() const;
        virtual void setSuggestMode(bool mode);
        virtual int sendBufferWatermark() const;
        virtual void setSendBufferWatermark(int value);
        virtual int sendBufferLowWatermark() const;
        virtual void setSendBufferLowWatermark(int value);
        virtual int sendBufferWatermarkFactor() const;
        virtual void setSendBufferWatermarkFactor(int value);
        virtual int connectionSpeed() const;
        virtual void setConnectionSpeed(int value);
        virtual int socketBacklogSize() const;
        virtual void setSocketBacklogSize(int value);
        virtual bool isAnonymousModeEnabled() const;
        virtual void setAnonymousModeEnabled(bool enabled);
        virtual bool isQueueingSystemEnabled() const;
        virtual void setQueueingSystemEnabled(bool enabled);
        virtual bool ignoreSlowTorrentsForQueueing() const;
        virtual void setIgnoreSlowTorrentsForQueueing(bool ignore);
        virtual int downloadRateForSlowTorrents() const;
        virtual void setDownloadRateForSlowTorrents(int rateInKibiBytes);
        virtual int uploadRateForSlowTorrents() const;
        virtual void setUploadRateForSlowTorrents(int rateInKibiBytes);
        virtual int slowTorrentsInactivityTimer() const;
        virtual void setSlowTorrentsInactivityTimer(int timeInSeconds);
        virtual int outgoingPortsMin() const;
        virtual void setOutgoingPortsMin(int min);
        virtual int outgoingPortsMax() const;
        virtual void setOutgoingPortsMax(int max);
        virtual int UPnPLeaseDuration() const;
        virtual void setUPnPLeaseDuration(int duration);
        virtual int peerToS() const;
        virtual void setPeerToS(int value);
        virtual bool ignoreLimitsOnLAN() const;
        virtual void setIgnoreLimitsOnLAN(bool ignore);
        virtual bool includeOverheadInLimits() const;
        virtual void setIncludeOverheadInLimits(bool include);
        virtual QString announceIP() const;
        virtual void setAnnounceIP(const QString &ip);
        virtual int maxConcurrentHTTPAnnounces() const;
        virtual void setMaxConcurrentHTTPAnnounces(int value);
        virtual bool isReannounceWhenAddressChangedEnabled() const;
        virtual void setReannounceWhenAddressChangedEnabled(bool enabled);
        virtual void reannounceToAllTrackers() const;
        virtual int stopTrackerTimeout() const;
        virtual void setStopTrackerTimeout(int value);
        virtual int maxConnections() const;
        virtual void setMaxConnections(int max);
        virtual int maxConnectionsPerTorrent() const;
        virtual void setMaxConnectionsPerTorrent(int max);
        virtual int maxUploads() const;
        virtual void setMaxUploads(int max);
        virtual int maxUploadsPerTorrent() const;
        virtual void setMaxUploadsPerTorrent(int max);
        virtual int maxActiveDownloads() const;
        virtual void setMaxActiveDownloads(int max);
        virtual int maxActiveUploads() const;
        virtual void setMaxActiveUploads(int max);
        virtual int maxActiveTorrents() const;
        virtual void setMaxActiveTorrents(int max);
        virtual BTProtocol btProtocol() const;
        virtual void setBTProtocol(BTProtocol protocol);
        virtual bool isUTPRateLimited() const;
        virtual void setUTPRateLimited(bool limited);
        virtual MixedModeAlgorithm utpMixedMode() const;
        virtual void setUtpMixedMode(MixedModeAlgorithm mode);
        virtual bool isIDNSupportEnabled() const;
        virtual void setIDNSupportEnabled(bool enabled);
        virtual bool multiConnectionsPerIpEnabled() const;
        virtual void setMultiConnectionsPerIpEnabled(bool enabled);
        virtual bool validateHTTPSTrackerCertificate() const;
        virtual void setValidateHTTPSTrackerCertificate(bool enabled);
        virtual bool isSSRFMitigationEnabled() const;
        virtual void setSSRFMitigationEnabled(bool enabled);
        virtual bool blockPeersOnPrivilegedPorts() const;
        virtual void setBlockPeersOnPrivilegedPorts(bool enabled);
        virtual bool isTrackerFilteringEnabled() const;
        virtual void setTrackerFilteringEnabled(bool enabled);
        virtual bool isExcludedFileNamesEnabled() const;
        virtual void setExcludedFileNamesEnabled(const bool enabled);
        virtual QStringList excludedFileNames() const;
        virtual void setExcludedFileNames(const QStringList &newList);
        virtual bool isFilenameExcluded(const QString &fileName) const;
        virtual QStringList bannedIPs() const;
        virtual void setBannedIPs(const QStringList &newList);
        virtual ResumeDataStorageType resumeDataStorageType() const;
        virtual void setResumeDataStorageType(ResumeDataStorageType type);
