...
namespace BitTorrent
{
    ...
    public:
        ...
        virtual QStringList getNetworkInterfaces() const = 0;
        ...
        virtual QMap<QString, QVariant> ports() const = 0;
        virtual void setPorts(const QMap<QString, QVariant> ports) = 0;
        virtual QMap<QString, QVariant> portsEnabled() const = 0;
        virtual void setPortsEnabled(const QMap<QString, QVariant> portsEnabled) = 0;
